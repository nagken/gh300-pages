# Practice GH-300 with Microsoft Copilot
...
<div class="qz-grid" id="qzGrid">
  <a class="qz-card" data-prompt="You are a GitHub GH-300 (GitHub Copilot) certification practice-exam coach. Quiz me one question at a time, exam-style (multiple choice or scenario). After I answer, tell me if I am right, give the correct answer, and a 2-3 line explanation tied to official GitHub docs (docs.github.com/copilot). Cover all GH-300 domains: Responsible AI (limitations, mitigations, public code filter); Plans and features (Free/Pro/Pro+/Business/Enterprise, IP indemnity, content exclusions, knowledge bases, custom models); How Copilot works and management (architecture, content exclusions, audit logs, telemetry, model picker); Prompt crafting (specificity, context, examples, iteration, slash commands, @workspace, #file:); Developer use cases (boilerplate, refactor, debug, docs, translation, tests, PR summaries); Testing with Copilot (/tests, edge cases, mocking, TDD); Privacy fundamentals (training opt-out, content exclusions, public code matching, telemetry). Do not show the answer until I commit. Start with question 1 now." data-target="copilot" href="#"><span class="qz-eyebrow">Full exam mode</span><h3>Sequential Practice Exam</h3><p>Exam-style questions across every GH-300 domain. One at a time, with a GitHub-docs-grounded explanation after each answer.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="GitHub GH-300 (GitHub Copilot) rapid-fire mode: ask me 20 short multiple-choice questions, one at a time. After each I answer, give one-line correctness and the right answer. At the end give my score and the 3 weakest topics with GitHub docs links to study. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Speed round</span><h3>Rapid-Fire (20 questions)</h3><p>Twenty short multiple-choice items back-to-back. Final score plus a ranked list of your three weakest topics with study links.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are a GH-300 GitHub Copilot coach. Drill me on plan/feature decision trees. Give a real-world scenario (org size, requirements, constraints) and 4 plausible Copilot plans or features as options. Wait for my answer, then explain why the right choice wins and why the others are traps. After I answer, give the next scenario. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Plan and feature selection</span><h3>Decision-Tree Drills</h3><p>"Which Copilot plan or feature?" scenarios with four plausible options. Distractors explained, not just the right answer.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are a GH-300 GitHub Copilot coach. Quiz me on the 50 most common 'gotchas' on the exam (e.g. .gitignore does not block Copilot, default training opt-in for personal plans, IP indemnity is Business+, knowledge bases are Enterprise only, /fix may rewrite the test instead of fixing the bug). One at a time, multiple choice, then explanation. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Trick questions</span><h3>Gotcha and Trap Drill</h3><p>The 50 most-confused exam distinctions: plan tiers, default-on/off filters, content exclusions vs gitignore, slash command behaviors.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="You are a GH-300 Copilot rollout coach. Give me one enterprise rollout scenario at a time (org size, compliance constraints, IDE mix, regulated paths). I will propose a Copilot configuration (plan, policies, content exclusions, model allow-list, audit setup). You critique it for completeness and security and give the GitHub-recommended pattern. Begin." data-target="copilot" href="#"><span class="qz-eyebrow">Rollout scenarios</span><h3>Enterprise Rollout Critique</h3><p>You propose a Copilot rollout config; the coach grades it for completeness and gives the GitHub-recommended pattern.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
  <a class="qz-card" data-prompt="I just took the GH-300 practice exam. First ask me which 2 domains I want to drill (Responsible AI / Plans and Features / How It Works / Prompt Crafting / Use Cases / Testing / Privacy). Then ask 10 deeper scenario questions on those domains with detailed explanations referencing GitHub docs. Begin by asking which domains." data-target="copilot" href="#"><span class="qz-eyebrow">Targeted study</span><h3>Weak-Area Deep Dive</h3><p>Tell Copilot the two domains you struggle with and get ten deeper scenario questions on those areas only.</p><span class="qz-cta">Copy prompt and open Copilot</span></a>
</div>

<div class="qz-alt">
  <button data-prompt="You are a GitHub GH-300 (GitHub Copilot) certification practice-exam coach. Quiz me one question at a time, exam-style (multiple choice or scenario). After I answer, tell me if I am right, give the correct answer, and a 2-3 line explanation tied to official GitHub docs. Cover all GH-300 domains: Responsible AI; Plans and features (Free/Pro/Pro+/Business/Enterprise); How Copilot works and management (content exclusions, audit logs, telemetry); Prompt crafting (slash commands, @workspace, #file:); Developer use cases; Testing with Copilot; Privacy fundamentals. Do not show the answer until I commit. Start with question 1 now." data-target="gemini">Open same prompt in Google Gemini</button>
...
5. Type `cite the GitHub docs page` after any answer for the official source link.
...
| --- | --- | --- |
| **Microsoft Copilot** ([copilot.microsoft.com](https://copilot.microsoft.com)) | Unlimited chats with any Microsoft account | Recommended starting point. |
| **Google Gemini** ([gemini.google.com](https://gemini.google.com)) | Free tier with any Google account | Optional second opinion. |
| **ChatGPT** ([chat.openai.com](https://chat.openai.com)) | Free tier | Optional second opinion. |
| **Claude** ([claude.ai](https://claude.ai)) | Free tier | Optional second opinion. |

> [!IMPORTANT]
> [GitHub docs](https://docs.github.com/copilot) is the authoritative source for GH-300 content. Use any LLM as a study aid and always confirm specific plan limits, feature availability, and policy on the official GitHub docs pages linked throughout this guide.
